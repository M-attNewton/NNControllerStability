...
% Add sector on non-linearity
grad_z3 = u_max(1)^2;
ineq_z3 = z(3)*(grad_z3*z(1) - z(3));
[prog,pr3] = sossosvar(prog,monomials(vars,0:orderm/2));
derVexpr = derVexpr - pr3*ineq_z3;
